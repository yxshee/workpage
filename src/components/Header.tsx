  ...
  return (
    <header className="header-bar fixed top-0 left-0 w-full grid grid-cols-3 items-center px-6 py-4 z-[120] pointer-events-none">
      <div className="pointer-events-auto justify-self-start">
        <Link href="/" className="text-lg font-black tracking-tight uppercase leading-none link-hoverable" style={{ color: 'var(--text-high)' }}>
          {personalInfo.name}
        </Link>
      </div>
      ...
      <nav className="pointer-events-auto justify-self-center flex gap-5 md:gap-10 items-center">
        ...
        <Link href="/archive" className="header-nav__link link-underline header-nav__link--muted u-hide-mobile">Archive</Link>
        <Link href="/info" className="header-nav__link link-underline header-nav__link--muted">Info</Link>
      </nav>
