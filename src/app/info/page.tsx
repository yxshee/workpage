      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
        <div>
          ...
          <div className="space-y-8">
            <section>
              <h3 className="text-xs font-black uppercase tracking-[0.14em] mb-4" style={{ color: 'var(--muted-500)' }}>Contact</h3>
              <div className="space-y-1">
                <p className="text-sm font-semibold" style={{ color: 'var(--text-high)' }}>{personalInfo.email}</p>
                <p className="text-sm font-semibold" style={{ color: 'var(--muted-500)' }}>{personalInfo.phone}</p>
                <p className="text-sm font-semibold" style={{ color: 'var(--muted-500)' }}>{personalInfo.location}</p>
                <a
